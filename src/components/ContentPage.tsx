...
const TEMPLATE_VARIABLES = [
  ...
  { key: '{{pax_types}}', label: 'Pax Types', description: 'Detailed breakdown (e.g., "5 Adulto, 3 Niño, 2 Gratuito")' },
  { key: '{{ticket_types}}', label: 'Ticket Types', description: 'Ticket breakdown from vouchers (e.g., "10 Intero, 3 Ridotto")' },
  ...
  { key: '{{guide_list}}', label: 'Guide List', description: 'All guides as "Name1 Phone1, Name2 Phone2"' },
  ...
  { key: '{{escort_list}}', label: 'Escort List', description: 'All escorts as "Name1 Phone1, Name2 Phone2"' },
...
const CONSOLIDATED_SERVICE_VARIABLES = [
  ...
  { key: '{{service.pax_types}}', label: 'Pax Types', description: 'Detailed breakdown (e.g., "5 Adulto, 3 Niño, 2 Gratuito")' },
  { key: '{{service.ticket_types}}', label: 'Ticket Types', description: 'Ticket breakdown from vouchers (e.g., "10 Intero, 3 Ridotto")' },
